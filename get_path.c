...
// 		clear_arr(env_paths);
// 	}
// 	error_exit(127, ft_strjoin(cmd, ": Command not found"));
// 	return (NULL);
// }

// static char	**get_path_arr(char *env_path_str, char *default_path_str)
// {
// 	char	**path_arr_temp;
// 	char	**path_arr;
// 	char	*full_path_str;
...
// 	path_arr = NULL;
// 	full_path_str = ft_strjoin(default_path_str, env_path_str + 5);
// 	path_arr_temp = ft_split(full_path_str + 5, ':');
// 	if (path_arr_temp != NULL)
// 	{
// 		path_arr = ft_map_s2a(path_arr_temp, "/\0", ft_strjoin);
// 		clear_arr(path_arr_temp);
...
// 	default_path = "PATH=/bin:/sbin:/usr/bin:/usr/sbin";
// 	i = 0;
// 	while (envp[i])
// 	{
// 		if (ft_strncmp(envp[i], "PATH=", 5) == 0)
// 			return (get_path_arr(envp[i], default_path));
// 		i++;
// 	}
// 	return (get_path_arr("", default_path));
// }